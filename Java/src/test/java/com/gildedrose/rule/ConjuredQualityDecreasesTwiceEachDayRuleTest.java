...
public class ConjuredQualityDecreasesTwiceEachDayRuleTest {

  ConjuredQualityDecreasesTwiceEachDayRule rule;

  @Before
  public void setUp() {
    rule = new ConjuredQualityDecreasesTwiceEachDayRule();
  }
  ...
  public void processTest() {
    Item item = new Item("Conjured Mana Cake", 2, 3);
