...
public class AgedBrieQualityIncreasesTwiceAfterExpiresRuleTest {

  AgedBrieQualityIncreasesTwiceAfterExpiresRule rule;

  @Before
  public void setUp() {
    rule = new AgedBrieQualityIncreasesTwiceAfterExpiresRule();
  }

  @Test
  public void isApplicableTest() {
    assertTrue(rule.isApplicable(new Item("Aged Brie", 0, 1)));
